                             ...
                             public void onSuccess(Response<Result<TaskOrder>> response) {
                                 ...
                                 if (result.isSuccess()) {
                                     ...
                                     for (TaskOrder.DataListBean bean :
                                             list) {
//                                         ['JIEJI', 'SONGJI', 'ORDER_SCENE', 'MEISHI_PRIVATE, 'JINGDIAN_PRIVATE']
                                         if ("JIEJI".equals(bean.getScene())||"SONGJI".equals(bean.getScene())||"ORDER_SCENE".equals(bean.getScene()) || "JINGDIAN_PRIVATE".equals(bean.getScene()) || "MEISHI_PRIVATE".equals(bean.getScene())) {
                                             mList.add(bean);
                                         }
                                     }
//                                     mList.addAll(list);
